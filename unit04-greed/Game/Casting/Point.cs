namespace unit04_greed.Game.Casting
{
    ...
    public class Point
    {
        ...
        /// <summary>
        /// Whether or not this Point is equal or between 10 px of the given one.
        /// </summary>
        /// <param name="other">The point to compare.</param>
        /// <returns>True if both x and y are within 5 px; false if otherwise.</returns>
        public bool Equals(Point other)
        {
            if(this.x > other.GetX() - 5 && this.x < other.GetX() + 5) {
                if(this.y > other.GetY() - 5 && this.y < other.GetY() + 5) {
                    return true;
                } else {
                    return false;
                }
