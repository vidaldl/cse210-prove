...
{
    /// <summary>
    /// Encapsulates the necessary write and read functions for this project.
    /// </summary>
    public class TerminalService
    {
        ...
        /// <summary>
        /// Gets numerical input from the terminal.
        /// </summary>
        /// <param name="prompt">The text we want to print on the screen;</param>
